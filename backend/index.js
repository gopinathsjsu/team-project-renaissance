...
db.sequelize.sync({ force: true }).then(() => {
  ...
  // This will not go in production 
  Account.bulkCreate([
    {account_no: '1000000000000001', account_type: 'checkin', account_balance: '12500', username: 'hsimpson'},
    {account_no: '1000000000000000', account_type: 'checkin', account_balance: '500', username: 'bsimpson'},
